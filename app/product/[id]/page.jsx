...
import { product } from "../../../Helper/product"; // assuming local data
    ...
    return (
        <>
                ...
                <div className="p-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center mt-10">
                    ...
                    <div className="flow-root">
                        <dl className="-my-3 divide-y divide-gray-200 text-sm">
                            ...
                            <button className="flex my-10 bg-amber-100 hover:text-cyan-950 text-amber-500 border-2 bg-amber-600-500 border-0 py-2 px-8 focus:outline-none hover:bg-amber-300 rounded text-lg">
                                <a
                                    href="https://wa.me/917870183270?text=Hello%20I%20am%20interested"
                                    target="_blank"
            ...
            <div className="mx-20 mt-5">
                <ProductList dataItem={product} active={false} />
            </div>
